...
router.get('/app.json',(req,res)=>{
    ...
    log(chalk.cyan('[react-openfin-scripts] config api 5# hosts::',req.headers.host));
    log(chalk.cyan('[react-openfin-scripts] config api 6# Host::',req.headers['Host']));
    log(chalk.cyan('[react-openfin-scripts] config api 7# X-Real-IP::',req.headers['X-Real-IP']));
    log(chalk.cyan('[react-openfin-scripts] config api 8# X-Forwarded-For::',req.headers['X-Forwarded-For']));
    log(chalk.cyan('[react-openfin-scripts] config api 9# X-Client-Verify::',req.headers['X-Client-Verify']));
    log(chalk.cyan('[react-openfin-scripts] config api 10# X-Client-DN::',req.headers['X-Client-DN']));
    log(chalk.cyan('[react-openfin-scripts] config api 11# X-SSL-Subject::',req.headers['X-SSL-Subject']));
    log(chalk.cyan('[react-openfin-scripts] config api 12# X-SSL-Issuer::',req.headers['X-SSL-Issuer']));
    log(chalk.cyan('[react-openfin-scripts] config api 13# some-other::',req.headers['some-other']));
